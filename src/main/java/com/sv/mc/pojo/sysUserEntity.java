...
public class sysUserEntity implements Serializable{
    ...
    private Collection<sysRoleEntity> roleEntities = new HashSet<>();
    ...
    public Collection<sysRoleEntity> getRoleEntities() {
        return roleEntities;
    }

    public void setRoleEntities(Collection<sysRoleEntity> roleEntities) {
